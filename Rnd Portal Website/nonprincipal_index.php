    ...
    <div class="container-fluid">
     ...
     <section class="design-process-section" id="process-tab">
                ...
                <div class="col-xs-12"> 
                    ...
                    <li role="presentation"><a href="#workshops" aria-controls="training" role="tab" data-toggle="tab"  id="workshops"><i class="fas fa-tools" aria-hidden="true"></i>
