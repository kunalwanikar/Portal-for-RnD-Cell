        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            <a href="#">
              ...
              <span>Allot Dean/HOD</span>
            </a>
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="#allotdean" aria-controls="allotdean" role="tab" data-togle="tab" id="allotdean">Allot Dean</a>
                </li>
                <li>
                  <a href="#allothod" aria-controls="allothod" role="tab" data-togle="tab" id="allothod">Allot HODs</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li>
            <a href="#new_registration" aria-controls="new_registration" role="tab" data-togle="tab" id="new_registration">
          ...
          <li>
            <a href="#report" aria-controls="report" role="tab" data-togle="tab" id="report">
              <i class="fa fa-book" aria-controls="true"></i>
              <span>Report</span></a>
          </li>
          <li>
          ...
          <li>
            <a href="#inactive_account" aria-controls="inactive_account" role="tab" data-togle="tab" id="inactive_account">
              <i class="fa fa-book" aria-controls="true"></i>
    ...
    <div class="container-fluid">
     ...
     <section class="design-process-section" id="process-tab">
                ...
                <div class="col-xs-12"> 
                    ...
                    <li role="presentation"><a href="#training" aria-controls="training" role="tab" data-toggle="tab"  id="training"><i class="fas fa-globe" aria-hidden="true"></i>
                        <p>Experience</p>
                        </a></li>

                    <li role="presentation"><a href="#workshops" aria-controls="workshops" role="tab" data-toggle="tab"  id="workshops"><i class="fas fa-tools" aria-hidden="true"></i>
                    ...
                    <div role="tabpanel" class="tab-pane active" >
                        <div class="design-process-content">
                        <?php include('inactive_account.php'); ?>
                        </div>
                    </div>
